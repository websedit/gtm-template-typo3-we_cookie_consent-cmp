...

{
  ...
  "description": "Integrate our CMP Script Tag to control the Google tools implemented on your TYPO3 website with the extension \"we_cookie_consent\" and manage the consent settings of your users regarding Google Consent Mode.\n\nMore info at https://consent.websedit.de/",
  "containerContexts": [
    "WEB"
  ]
}
