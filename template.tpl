...

{
  ...
  "description": "Integrate our CMP Script Tag to easily control scripts implemented on your TYPO3 website with extension \"we\" and manage consent settings of your users.\n\nMore info at https://consent.websedit.de/",
  "containerContexts": [
    "WEB"
  ]
}
